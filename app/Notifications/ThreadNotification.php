...
//    }
    ...
    private function extractData($replyId) {
        ...
        return \App\Reply::select('users.name as author', 'threads.id as thread_id', 'channels.slug as thread_channel_slug', DB::raw("CONCAT(LEFT(threads.title, 99), IF(LENGTH(threads.title)>99,'...','')) AS thread_title"))
