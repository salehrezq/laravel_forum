    ...
    <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
        <div class="container">
            ...
            <div class="nav-item dropdown">
                <a class="nav-link dropdown-toggle menu-channels-link" href="#" id="navbarDropdownMenuLink"
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                    ...
                    @if(auth()->check())
                        <a class="dropdown-item" href="{{ route('threads.index', ['user_id' => auth()->user()->id])}}">My
                            threads</a>
                    @endif
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                    @foreach ($channels as $channel)
                        <a class="dropdown-item"
                           href="{{route('threads.channel', ['channelSlug' => $channel->slug])}}">{{$channel->slug}}</a>
                    @endforeach
                </div>
            </div>
            @auth
                    ...
                    @else
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <a href="{{ route('users.settings.get', ['user' => auth()->user()->username]) }}"
...
@if(session('confirm-email-sent-flash'))
    <div class="container">
        <div class="row">
            <div class="col-8 mx-auto">
                <div class="alert alert-success alert-dismissible">
                    <a href="#" class="close email-confirm-flash-close" aria-label="close">&times;</a>
                    {{ session('confirm-email-sent-flash') }}
                </div>
            </div>
        </div>
    </div>
